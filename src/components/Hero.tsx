        ...
        <div className="relative bg-[#f1f1f1] z-10 pb-8  sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          ...
          <div className="pt-10 mx-auto max-w-7xl bg-[#f1f1f1]  sm:pt-12  md:pt-16 lg:pt-20  xl:pt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl font-extrabold cf tracking-tight  text-gray-900 sm:text-5xl md:text-6xl">
              ...
              <Link
                ...
                className="mb-3 sm:mb-0 sm:mr-4 inline-block px-6 py-3 text-base font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700"
              >
                Browse Products
              </Link>
              <Link
